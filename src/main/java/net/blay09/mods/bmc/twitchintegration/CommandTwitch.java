		...
		if(twitchClient != null) {
			if(args[0].startsWith("#")) {
				...
				if(message.startsWith("/me ")) {
					...
					twitchChatHandler.onChatMessage(twitchClient, args[0], twitchChatHandler.getThisUser(twitchClient), new TwitchMessage(message, true, 0));
				} else {
					twitchChatHandler.onChatMessage(twitchClient, args[0], twitchChatHandler.getThisUser(twitchClient), new TwitchMessage(message, false, 0));
				}
			} else {
